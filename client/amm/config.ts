export const SILVERBACK_V2_FACTORY =
  (import.meta as any).env?.VITE_SB_V2_FACTORY || "0x63FfE8C2d8D82eCd2C43e489a99c7e66902cD98a";
export const SILVERBACK_V2_ROUTER =
  (import.meta as any).env?.VITE_SB_V2_ROUTER || "0x6FBe8fCA4EA7a81Bdd6AC258c4ed9E2C502b017C";
