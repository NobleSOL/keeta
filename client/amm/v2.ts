import { SILVERBACK_V2_FACTORY, SILVERBACK_V2_ROUTER, isAddress } from "./config";
...
export const v2Abi = {
  ...
  router: [
    { type: "function", name: "addLiquidity", stateMutability: "nonpayable", inputs: [
      {name:"tokenA",type:"address"},{name:"tokenB",type:"address"},{name:"amountADesired",type:"uint256"},{name:"amountBDesired",type:"uint256"},{name:"amountAMin",type:"uint256"},{name:"amountBMin",type:"uint256"},{name:"to",type:"address"},{name:"deadline",type:"uint256"}
    ], outputs: [{name:"amountA",type:"uint256"},{name:"amountB",type:"uint256"},{name:"liquidity",type:"uint256"}] },
  ] as const,
};

export function v2Addresses() {
  if (!isAddress(SILVERBACK_V2_FACTORY) || !isAddress(SILVERBACK_V2_ROUTER)) return null;
  return { factory: SILVERBACK_V2_FACTORY as Address, router: SILVERBACK_V2_ROUTER as Address };
}
