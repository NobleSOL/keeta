export const AGG_SOURCES = ["aerodrome", "sushi", "uniswapv2", "uniswapv3"] as const;
export type AggSource = (typeof AGG_SOURCES)[number];

export const FEE_BPS = 30; // 0.3%
export const FEE_RECIPIENT = "0x360c2eB71dd6422AC1a69FbBCA278FFc2280f8F7" as const;
...
export const BASE_RPC_URL = (import.meta as any).env?.VITE_BASE_RPC_URL || "https://mainnet.base.org";
